...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- tombol tambah -->
        <a href="" class="btn btn-primary mb-4" class="btn btn-primary" data-toggle="modal" data-target="#addNewMenu">Add Menu</a>
        <!-- Tabel -->
...
<!-- Modal Tambah -->
<div class="modal fade" id="addNewMenu" tabindex="-1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            name="is_active" name="is_active" checked>
    ...
    <div class="modal-dialog" role="dokumen">
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/submenuedit'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" value="<?=$sm['title']?>" class="form-control" 
                        id="title" name="title" placeholder="Submenu title">
                    </div>
                    <div class="form-group">
                    <input type="hidden" class="form-control" id="id" name="id"
